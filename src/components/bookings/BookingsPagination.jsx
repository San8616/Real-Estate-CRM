  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 rounded-2xl border border-slate-200/80 bg-white px-5 py-3.5 shadow-xs">
      ...
      <div className="text-xs text-slate-500 font-medium">
        ...
        <span className="font-semibold text-slate-900">{totalItems}</span> bookings
      </div>
      ...
      <div className="flex items-center gap-1.5 self-end sm:self-auto">
        ...
        <button
          ...
          className="inline-flex items-center gap-1 rounded-xl border border-slate-200 bg-white px-2.5 py-1.5 text-xs font-semibold text-slate-700 transition-colors hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-40 cursor-pointer"
        >
